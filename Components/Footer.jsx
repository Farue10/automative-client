...
const Footer = () => {
    return (
     ...
     <div className='flex'>
      <img className='w-56 ' src={backgorundImg1}></img>
      <img className='w-56 h-40' src={backgorundImg2}></img>
     </div>
     <h2 className='text-3xl'>this our Automative Card Braning  Information</h2>
      <nav>
